...
public class AssetManager {
        ...
        if (ImGui.beginCombo("##MapKeysCombo", "Select SpriteSheet")) {
            ...
            while (iterator.hasNext()) {
                ...
                if (ImGui.selectable(option)) {
                    ...
                    iterator.remove();
                    ResourceManager.deleteFile(filePath);
                    ResourceManager.removeGSONReferenceFile(filePath, directory, fileType);
                }
            }
            ImGui.endCombo();
        }
    ...
    private boolean checkAndHandleErrors(String fileName, String type, int spriteWidth, int spriteHeight, int amount) {
        ...
        if (spriteSheets.get(ResourceManager.getSpriteSheet(fileName)) != null) {
