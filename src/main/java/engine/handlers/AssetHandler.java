...
public class AssetHandler {
    ...
    private boolean checkAndHandleErrors(String fileName, String type, int spriteWidth, int spriteHeight, int amount) {
        ...
        if (spriteSheets.get(ResourceHandler.getSpriteSheet(fileName)) != null) {
